export default {
  common: {
    ...
    queryError: 'Failed to query data'
  },
  lock: {
  ...
  login: {
    ...
    codePlaceholder: 'Please input SMS code',
    getCode: 'Get code',
    countdown: '{seconds}s',
  ...
  iconDemo: {
    ...
    recommendeDes:
      'Icon component wraps Element Plus Icons and local SVG icons for stable intranet usage.',
